...
GroupRepository::GroupRepository(pqxx::connection& cx) : cx_(cx) {
...
bool GroupRepository::create(int64_t id) {
  pqxx::work tx{cx_};
...
std::optional<int64_t> GroupRepository::read(int64_t id) {
  pqxx::work tx{cx_};
...
bool GroupRepository::remove(int64_t id) {
  pqxx::work tx{cx_};
...
bool GroupRepository::exists(int64_t id) {
  pqxx::work tx{cx_};
